...
public class Lab1_660019 {
    ...
    public static void task2() {
        ...
        sb.append("mySuffix");
        System.out.println(lis1b.get(0));
        ...
        /* your code */
        if (lis1b.get(0).equals(lis1a.get(0))){
            System.out.println("shallow copy");
        }
        else{
            System.out.println("Not shallow copy");
        }
    ...
    public static void task3() {
        ...
        /* your code */
        List<String> tmp = new ArrayList<>(lis3);
    ...
    public static void task4() { // show unique elements
        ...
        System.out.println();
        ArrayList<Dog_660019> lis4b = new ArrayList<>(Arrays.asList(
            new Dog_660019(Breed.pomeranian,1200), 
            new Dog_660019(Breed.beagle, 2300), 
            new Dog_660019(Breed.jack, 1440), 
            new Dog_660019(Breed.beagle,2300)));
        HashSet<Dog_660019> dogs = new HashSet<>(lis4b);
        for (Dog_660019 ele : dogs) {
            System.out.print(ele + " ");
        }
        System.out.println();
    }
    static void task5() { // dog breed frequency 
        ...
        ArrayList<Dog_660019> lis5 = new ArrayList<>(Arrays.asList(
            new Dog_660019(Breed.pomeranian,1200), 
            new Dog_660019(Breed.beagle, 2300), 
            new Dog_660019(Breed.jack, 1440), 
            new Dog_660019(Breed.beagle,2300)));
        ...
        /* your code */
        for (int i = 0; i < lis5.size(); i++){
            if (map.isEmpty()){
                map.put(lis5.get(i).getBreed(), 1);
            }
            else{
                if (map.containsKey(lis5.get(i).getBreed())){
                    map.put(lis5.get(i).getBreed(), map.get(lis5.get(i).getBreed())+1);
                }
                else{
                    map.put(lis5.get(i).getBreed(), 1);
                }
    ...
    static void task6() { // number of unique elements
        ...
        ArrayList<Dog_660019> lis6 = new ArrayList<>(Arrays.asList(new Dog_660019(Breed.pomeranian,1200), new Dog_660019(Breed.beagle, 2300), new Dog_660019(Breed.jack, 1440), new Dog_660019(Breed.beagle,2300)));        
        /* your code */
        System.out.print("The number of unique element is " + lis6.stream().map(Dog_660019::getBreed).distinct().count());
    }
