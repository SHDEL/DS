...
import solutions.pack9_Heap.MyHeapSort_660019;
import solutions.pack9_Heap.MyMinHeap_660019;
import solutions.pack9_Heap.MyPriorityQueue_660019;
...
public class Lab9_PQ {
    ...
    static void task2() {
        least3 = new ArrayList<>();
        MyPriorityQueue_660019 pq = new MyPriorityQueue_660019();
        pq.enqueue(11);
        pq.enqueue(15);
        pq.enqueue(16);
        pq.enqueue(13);
    ...
    static void task3() {
        MyHeapSort_660019 heap = new MyHeapSort_660019();
        heap.insert(11);
        heap.insert(15);
        heap.insert(16);
        heap.insert(13);
